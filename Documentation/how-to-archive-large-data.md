...
# Case study: dragonfly-core Repository 
...
```bash
$ mkdir dragonfly-core
$ cd    dragonfly-core
$ git remote add upstream https://github.sec.samsung.net/RS7-AutoDriving/dragonfly-core.git
$ git remote add origin   https://github.sec.samsung.net/<your_github_id>/dragonfly-core.git
$ git fetch upstream
